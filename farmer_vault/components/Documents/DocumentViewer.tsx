  ...
  return (
    <ResizablePanelGroup orientation="horizontal" className="h-full">
      ...
      <ResizablePanel defaultSize="55%" minSize="30%">
        <section
          className="h-full bg-[var(--card)] overflow-auto flex flex-col"
      ...
      <ResizablePanel defaultSize="45%" minSize="30%" collapsible collapsedSize="0%">
        ...
        <header className="p-6">
          <h1 className="text-lg font-mono mb-2 truncate text-foreground" title={document.filename}>
            {document.filename}
          </h1>
        ...
        <Tabs defaultValue="ocr" className="flex-1 flex flex-col min-h-0">
          <TabsList variant="line" className="w-full justify-start px-6 pt-2">
            <TabsTrigger value="ocr" className="font-mono text-sm">
              OCR {languageDisplayName && <span className="text-xs opacity-60">({languageDisplayName})</span>}
            </TabsTrigger>
            {hasTranslation && (
              <TabsTrigger value="translated" className="font-mono text-sm">
                English
              </TabsTrigger>
            )}
            <TabsTrigger value="entities" className="font-mono text-sm">
